...
I created this library/collection of libraries to improve ease of use and to extend [Elementary](https://github.com/elementary-swift/elementary) as a whole

## Future directions

- [x] Add library for all current shoelace components
  - [ ] Implement custom properties
- [ ] Create custom components (Paginator, DataTable, DataTableFilter) using Elementary and [ElemtnaryHTMX](https://github.com/elementary-swift/elementary-htmx)
